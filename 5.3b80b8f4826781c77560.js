...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Volumes/MACDATA/VueWorkspaces/Qjzd-vue/src/views/message.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        markall: function markall() {
	            $.post('https://qjzd.net/api/v1/message/mark_all', { accesstoken: localStorage.token }, function (d) {
	                if (d && d.success) {
...
//# sourceMappingURL=5.3b80b8f4826781c77560.js.map